...
#define CHECK_WEATHER_TIMEOUT   3630L  // was: 21613L    Weather check interval (in seconds)
#define CHECK_WEATHER_SUCCESS_TIMEOUT 21613L // was: 86400L   Weather check success interval (in seconds)
